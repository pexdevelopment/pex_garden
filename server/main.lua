...
RegisterServerEvent('d_cleanergive:givereceipt')
AddEventHandler('d_cleanergive:givereceipt', function()
...
RegisterServerEvent('d_sellreceipts')
AddEventHandler('d_sellreceipts', function(lockerNumber)
